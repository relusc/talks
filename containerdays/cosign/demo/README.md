...
Just execute the `./setup/setup.sh` script. This will start colima, create the `kind` cluster, etup the Sigstore Policy Controller and initiate a login to `ghcr.io`.
